  ...
  function adminPanel(tab) {
    ...
    switch (tab) {
      ...
      case 'delivery': return `<h2>Correo y WhatsApp</h2>
          ...
          <div class="form-grid">${field('URL del backend (endpoint de envío)', 'delivery.apiEndpoint', { full: true, hint: 'Ejemplo: https://evaluaciones.midominio.com/api/assessments · Vacío = modo configuración (no se envía nada).' })}
